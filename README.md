...
```text
npm install --global github:ivan-tretyakov/airlock#v4.0.0
```
...
The automated tests cover schema invariants, the v3 to v4 upgrade, lifecycle transitions, assumption rework, Git audits including shell-created writes, budget caps via `expensive`, and the 5,000-byte prompt-surface ceiling.
